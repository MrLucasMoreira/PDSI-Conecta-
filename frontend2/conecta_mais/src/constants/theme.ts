/** Temas, icones e fontes do aplicativo. */
...
export const ASSINATURA = 'pessoas conectadas, ideias em movimento.';
...
export const TIPOGRAFIA = {
  display: { fontFamily: FONTES.display, fontSize: 32, lineHeight: 40 },
  assinatura: { fontFamily: FONTES.display, fontSize: 15, lineHeight: 22 },
...
export const TEMAS = { claro: temaClaro, escuro: temaEscuro } as const;

/** Devolve o tema conforme a aparência escolhida no aparelho. */
